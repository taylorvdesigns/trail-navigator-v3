...
interface NavContextCardV3Props {
  destination: string;
  trail: string;
...
/**
 * NavContextCardV3 Component (Formerly V1)
 * 
 * Design: Classic 3-column layout with circular center
 * Features:
 * - Heading with destination and trail pills
 * - 3-column grid: Entry point info, circular locomotion center, elevation description
 * - Circular center with locomotion icons and mode selection
